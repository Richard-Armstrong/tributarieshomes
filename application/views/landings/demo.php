 ...
 <div id="navbar-full">
    ...
    <div class="navigation-example">
        ...
        <!-- Collect the nav links, forms, and other content for toggling -->
            ...
            <div class="img-src" style="background-image: url('<?=base_url();?>assets/img/bg.jpg')"></div>
        </div>
    </div><!--  end navbar -->
        ...
        <div id="images">
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6">
                    <h4>Rounded Image</h4>
                    <img src="<?=base_url();?>assets/img/mockup.png" alt="Rounded Image" class="img-rounded">

                </div>
                <div class="col-md-4 col-sm-6">
                    <h4>Circle Image</h4>
                    <img src="<?=base_url();?>assets/img/mockup.png" alt="Circle Image" class="img-circle">

                </div>
                <div class="col-md-4 col-sm-6">
                    <h4>Thumbnail Image</h4>
                    <img src="<?=base_url();?>assets/img/mockup.png" alt="Thumbnail Image" class="img-thumbnail">
    ...
    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="item active">
          <img src="<?=base_url();?>assets/img/carousel_blue.png" alt="Awesome Image">
        </div>
        <div class="item">
          <img src="<?=base_url();?>assets/img/carousel_green.png" alt="Awesome Image">
        </div>
        <div class="item">
          <img src="<?=base_url();?>assets/img/carousel_red.png" alt="Awesome Image">
        </div>
      </div>
            ...
            <div class="row">
                <div class="col-md-7 col-md-offset-0 col-sm-10 col-sm-offset-1">
                    <div class="text-center">
                        <img src="<?=base_url();?>assets/img/dulau.jpg" alt="Rounded Image" class="img-rounded img-responsive img-dog">
                    </div>
                </div>
